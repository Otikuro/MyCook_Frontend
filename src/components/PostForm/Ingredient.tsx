...
export default function Ingredient({ ingredient, allMethods, deleteIngredientHandler }: { ingredient: IngredientType, allMethods: any, deleteIngredientHandler: (ingredient_id: number) => void }) {
